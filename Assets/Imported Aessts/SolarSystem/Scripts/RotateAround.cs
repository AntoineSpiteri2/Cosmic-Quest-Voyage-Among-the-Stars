...
public class RotateAround : MonoBehaviour {
    ...
    private void Awake()
    {
        globalValuesScript = FindObjectOfType<GlobalValues>();
	...
	void Update () {
        ...
        transform.RotateAround(centerMass.position, Vector3.up, Time.deltaTime * (defaultEarthYear / rotationAroundSunDays) * (0.5f) * Time.deltaTime);
